                ...
                <View style={styles.row}>
                    <TouchableOpacity
                        style={[
                            styles.button,
                            {
                                backgroundColor: xpBoost === 3 || xpBoost === 23 ? Color.accent : '#fff3',
                    ...
                    <TouchableOpacity
                        style={[
                            styles.button,
                            {
                                backgroundColor: xpBoost === 20 || xpBoost === 23 ? Color.accent : '#fff3',
            ...
            <View style={styles.resultsContainer}>
                ...
                <View style={styles.resultRow}>
                    ...
                    <Text style={styles.resultText}>
                        {Math.floor(realRemainingXp() / remainingDays / gamemodeInfo.competitive.avgXpPerMatch + 1)}
                    </Text>
                </View>
                <View style={styles.resultRow}>
                    <Text style={styles.resultTitle}>Spike Rush per Day</Text>
                    <Text style={styles.resultText}>
                        {Math.floor(realRemainingXp() / remainingDays / gamemodeInfo['spike-rush'].avgXpPerMatch + 1)}
                    </Text>
                </View>
                <View style={styles.resultRow}>
                    ...
                    <Text style={styles.resultText}>
                        {Math.floor(
                            realRemainingXp() / remainingDays / gamemodeInfo['team-deathmatch'].avgXpPerMatch + 1,
                        )}
                    </Text>
                </View>
                <View style={styles.resultRow}>
                    ...
                    <Text style={styles.resultText}>
                        {Math.floor(realRemainingXp() / remainingDays / gamemodeInfo.deathmatch.avgXpPerMatch + 1)}
                    </Text>
                </View>
                <View style={styles.resultRow}>
