...
export default function SettingsScreen() {
  ...
  let statsPeriodArray: string[] = [];
  for (let key in EStatsPeriod) {
    statsPeriodArray.push(key);
  }
      ...
      <TouchableOpacity
        ...
        <View
          style={[
            styles.sideBox,
            {left: 24},
            showStoreVideo && styles.sideBoxActive,
          ]}
        />
      ...
      <TouchableOpacity
        ...
        <View
          style={[
            styles.sideBox2,
            {left: 24},
            autoplayStoreVideo && showStoreVideo && styles.sideBoxActive,
          ]}
        />
