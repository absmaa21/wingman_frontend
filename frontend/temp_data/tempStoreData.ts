...
export const tempFeaturedItemsData = [
    {
        OfferID: 'b6e6ea9e-432d-ec17-904e-62a5ea45f1a7',
        IsDirectPurchase: true,
        StartDate: '2024-01-16T11:51:59.475885493Z',
        Cost: {
        ...
        Rewards: [
            {
                ItemTypeID: 'e7c63390-eda7-46e0-bb7a-a6abdacd2433',
                ItemID: 'b6e6ea9e-432d-ec17-904e-62a5ea45f1a7',
                Quantity: 1,
            },
        ],
    },
    {
        OfferID: '369c9f89-49fa-94bc-f3f8-b9b94b6395af',
        IsDirectPurchase: true,
        StartDate: '2024-01-16T11:51:59.475941538Z',
        Cost: {
            '85ad13f7-3d1b-5128-9eb2-7cd8ee0b5741': 1775,
        },
        Rewards: [
            {
                ItemTypeID: 'e7c63390-eda7-46e0-bb7a-a6abdacd2433',
                ItemID: '369c9f89-49fa-94bc-f3f8-b9b94b6395af',
                Quantity: 1,
            },
        ],
    },
    {
        OfferID: '8af83962-4e2f-f58e-588e-ef85e4882b79',
        IsDirectPurchase: true,
        StartDate: '2024-01-16T11:51:59.475964795Z',
        Cost: {
            '85ad13f7-3d1b-5128-9eb2-7cd8ee0b5741': 1775,
        },
        Rewards: [
            {
                ItemTypeID: 'e7c63390-eda7-46e0-bb7a-a6abdacd2433',
                ItemID: '8af83962-4e2f-f58e-588e-ef85e4882b79',
                Quantity: 1,
            },
        ],
    },
    {
        OfferID: 'c1326ee3-47af-d823-6686-618e1bcdf0c6',
        IsDirectPurchase: true,
        StartDate: '2024-01-16T11:51:59.475886259Z',
        Cost: {
        ...
        Rewards: [
            {
                ItemTypeID: 'e7c63390-eda7-46e0-bb7a-a6abdacd2433',
                ItemID: 'c1326ee3-47af-d823-6686-618e1bcdf0c6',
                Quantity: 1,
            },
        ],
    },
...
export const tempAccessoryItemsData = [
    {
        Offer: {
            OfferID: '399c4cde-532b-5476-a671-fc40aeaa2933',
            IsDirectPurchase: true,
            ...
            Rewards: [
                {
                    ItemTypeID: 'd5f120f8-ff8c-4aac-92ea-f2b5acbe9475',
                    ItemID: 'cbcd99a5-49db-d39f-a060-67a781d1605a',
                    Quantity: 1,
                },
            ],
        },
        ContractID: '5bef6de8-44d4-ac64-3df2-078e618fc0e3',
    },
    {
        Offer: {
            OfferID: 'c5fabd13-de59-5a05-8137-b5319a57c99c',
            IsDirectPurchase: true,
            StartDate: '2012-01-01T00:00:00Z',
            Cost: {
                '85ca954a-41f2-ce94-9b45-8ca3dd39a00d': 7500,
            },
            Rewards: [
                {
                    ItemTypeID: 'playercard',
                    ItemID: '6c1a9a5c-4fc8-8ff7-5fb9-3b957b4fe2ac',
                    Quantity: 2,
                },
            ],
        },
        ContractID: 'c1cd8895-4bd2-466d-e7ff-b489e3bc3775',
    },
    {
        Offer: {
            OfferID: 'f29d8300-0cea-5d41-bcec-d15c458d7d96',
            IsDirectPurchase: true,
            StartDate: '2012-01-01T00:00:00Z',
            Cost: {
            ...
            Rewards: [
                {
                    ItemTypeID: 'd5f120f8-ff8c-4aac-92ea-f2b5acbe9475',
                    ItemID: '501b7d18-49f6-8467-759f-66abf39c98d6',
                    Quantity: 1,
                },
            ],
        },
    ...
    {
        Offer: {
            OfferID: 'b18992bd-32cf-51a2-bf1b-ed92d0ef2252',
            IsDirectPurchase: true,
            StartDate: '2012-01-01T00:00:00Z',
            Cost: {
                '85ca954a-41f2-ce94-9b45-8ca3dd39a00d': 7500,
        ...
        ContractID: '7b06d4ce-e09a-48d5-8215-df9901376fa7',
    },
];
