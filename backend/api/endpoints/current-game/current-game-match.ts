...
import ICurrentGameMatch from '../../types/current-game/current-game-match';

class CurrentGameMatchEndpoint extends CachedEndpoint<
    ICurrentGameMatch,
...
> {
    ...
    public endpoint(): string {
        return `core-game/v1/matches/${this.currentGameMatchId}`;
    }
    ...
    public refreshTimeoutDuration(_data: ICurrentGameMatch): number {
        return 1000 * 10;
    }
}

export default CurrentGameMatchEndpoint;
