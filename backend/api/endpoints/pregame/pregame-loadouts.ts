...
class PreGameLoadoutsEndpoint extends CachedEndpoint<IPreGameLoadouts, EnumError<ValorantClientError>, ValorantClient> {
    public user: IUser;
    ...
    public endpoint(): string {
        return `pregame/v1/matches/${this.pregameMatchId}/loadouts`;
    }
    ...
    public refreshTimeoutDuration(_data: IPreGameLoadouts): number {
        return 1000 * 10;
    }
}

export default PreGameLoadoutsEndpoint;
