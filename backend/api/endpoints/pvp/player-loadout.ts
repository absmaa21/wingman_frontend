...
import IPlayerLoadout from '../../types/pvp/player-loadout';

class PlayerLoadoutEndpoint extends CachedEndpoint<IPlayerLoadout, EnumError<ValorantClientError>, ValorantClient> {
    public user: IUser;
    public puuid?: string;
    ...
    public endpoint(): string {
        ...
        return `personalization/v2/players/${puuid}/playerloadout`;
    }
    ...
    public refreshTimeoutDuration(_data: IPlayerLoadout): number {
        return 1000 * 60 * 5;
    }
}

export default PlayerLoadoutEndpoint;
