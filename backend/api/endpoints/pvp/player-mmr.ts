...
import IPlayerMMR from '../../types/pvp/player-mmr';

class PlayerMMREndpoint extends CachedEndpoint<IPlayerMMR, EnumError<ValorantClientError>, ValorantClient> {
    public user: IUser;
    public puuid?: string;
    ...
    public refreshTimeoutDuration(_data: IPlayerMMR): number {
        return 1000 * 60 * 5;
    }
}

export default PlayerMMREndpoint;
