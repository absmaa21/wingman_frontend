...
import ValorantClient, {
  ValorantClientError,
} from '../../clients/valorant-client';
...
class PlayerMMREndpoint extends CachedEndpoint<
  IPlayerMMRResponse,
...
> {
  ...
  public refreshTimeoutDuration(_data: IPlayerMMRResponse): number {
    return 1000 * 60 * 5;
  }
}
